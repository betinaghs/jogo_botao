...
home = pygame.image.load ('home.jpg') #imagem do botao 3


font = pygame.font.SysFont(None, 30)
DEFALT_IMAGE_SIZE = (800, 600) 
background = pygame.transform.scale(background, DEFALT_IMAGE_SIZE) #redimensionar
...
def main_menu():
    while True:
        ...
        screen.blit(home,(00,200))     #aparece a imagem
        ...
        home = pygame.Rect(300, 400, 200, 50) #criando botao com imagem
        ...
        pygame.draw.rect(screen, (255, 0, 0), home) #botao home imagem
